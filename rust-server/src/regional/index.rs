use super::{RegionFile, RegionLayout, RegionSectionEntry, store::SECTION_ENTRY_BYTES};
use anyhow::{Context, Result, bail};

const INDEX_MAGIC: &[u8; 8] = b"VXYRIDX\0";
const INDEX_HEADER_BYTES: usize = 36;
const INDEX_ENTRY_BYTES: usize = SECTION_ENTRY_BYTES;
...
mod tests {
    ...
    #[test]
    fn packed_region_index_round_trips() {
        ...
        entries[4] = RegionSectionEntry {
            flags: 1 << 15,
            payload_offset: 1234,
            compressed_length: 88,
            canonical_length: 512,
            compressed_crc: 0x1234_5678,
            fingerprint: [7; 16],
            ..RegionSectionEntry::default()
        };
