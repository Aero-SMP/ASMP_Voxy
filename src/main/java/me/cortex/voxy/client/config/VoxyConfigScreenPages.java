        ...
        groups.add(OptionGroup.createBuilder()
                .add(OptionImpl.createBuilder(boolean.class, storage)
                    ...
                    .setBinding((s, v) -> s.fogDensity = v / 10.0f, s -> (int)(s.fogDensity * 10))
                                        ...
                                        .setName(Component.literal("Link fog to render distance"))
                                        .setTooltip(Component.literal("Ignore Custom Fog End and use Voxy render distance instead. Fog start and color still come from Custom Fog"))
                                        .setControl(TickBoxControl::new)
                                        .setBinding((s, v) -> s.linkFogToRenderDistance = v, s -> s.linkFogToRenderDistance)
                                        .build()
